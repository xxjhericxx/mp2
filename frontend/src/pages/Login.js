  ...
  return (
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
      <form class="bg-white">
        ...
        <p class="text-sm font-normal text-gray-600 mb-7">Welcome Back to our Site!</p>
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <a href='/signup' class="text-sm ml-2 hover:text-blue-500 cursor-pointer" >Don't Have an Account ?</a>
      </form>
    </div>
  </div>
  );
